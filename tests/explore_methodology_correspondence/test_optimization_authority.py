...
from gymact.explore_methodology_correspondence.intervention import (
    InterventionIntent,
    require_non_actuating,
)
...
class TestOptimizationAuthority(unittest.TestCase):
    def test_frontier_and_do_refusal(self):
        a = Candidate("a", Fraction(2), Fraction(1))
        b = Candidate("b", Fraction(1), Fraction(2))
