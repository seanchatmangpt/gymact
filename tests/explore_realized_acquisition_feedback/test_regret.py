...
class TestRegret(unittest.TestCase):
    def test_regret(self):
        a = AcquisitionRealization("a", Fraction(1,2), Fraction(1,4), Fraction(1,10), 1)
        b = AcquisitionRealization("b", Fraction(1,2), Fraction(3,4), Fraction(1,10), 1)
        self.assertEqual(realized_regret(a, [b]), Fraction(1,2))
