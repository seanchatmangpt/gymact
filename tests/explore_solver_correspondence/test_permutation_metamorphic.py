...
from gymact.explore_solver_correspondence.permutation import permute_measure, permute_metric
...
def test_label_permutation_preserves_transport_cost():
    subject = SolverSubject("seanchatmangpt/gymact", "d51231730796ef512cc942462a789d69f009affd", "permutation")
    ...
    transformed = run_primal(subject, permute_measure(a, mapping), permute_measure(b, mapping), permute_metric(metric, mapping))
