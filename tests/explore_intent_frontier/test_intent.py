...
class TestIntent(unittest.TestCase):
    def test_half_open_lease(self):
        ...
        t=datetime(2026,8,22,tzinfo=timezone.utc); i=SelectionIntent(c,"nonce-0001",t,t+timedelta(minutes=5))
        self.assertTrue(i.active(t)); self.assertFalse(i.active(t+timedelta(minutes=5)))
