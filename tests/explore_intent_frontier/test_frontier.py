...
class TestFrontier(unittest.TestCase):
    def test_divergent_latest_intents_refuse(self):
        ...
        x = SelectionIntent(a, "nonce-0001", t, t + timedelta(hours=1))
        y = SelectionIntent(b, "nonce-0002", t, t + timedelta(hours=1))
        with self.assertRaisesRegex(ValueError, "REFUSED_DIVERGENT_INTENT_FRONTIER"):
            resolve((x, y), t)
