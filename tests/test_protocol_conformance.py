    ...
    vectors.write_text(
        json.dumps(
            [
                {
                    "id": "allow",
                    "request": {"authority": "exact", "receipt_capable": True},
                    "expect": {"disposition": "ADMITTED", "code": "ALLOWED"},
                },
                {
                    "id": "refuse",
                    "request": {"authority": None, "receipt_capable": True},
                    "expect": {"disposition": "REFUSED", "code": "REFUSED:NO_STANDING"},
                },
            ]
        )
    )
