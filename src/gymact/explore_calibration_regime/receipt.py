...
def issue(payload):
    ...
    body["schema"] = "gymact.explore-calibration-regime/1"
...
def replay(r):
    if (
        r.payload.get("schema") != "gymact.explore-calibration-regime/1"
        or r.payload.get("actuation_performed") is not False
    ):
        return False
