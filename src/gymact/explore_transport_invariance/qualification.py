...
def qualify(candidate: Candidate, calibration: Calibration, stressed_risks: tuple[Fraction, ...], max_risk: Fraction) -> Qualification:
    require(bool(stressed_risks), "MISSING_STRESS_EVIDENCE", "at least one stress world is required")
