...
SREGYM_CAPABILITY_ROWS = (
    {
        ...
        "title": "Read SREGym conductor status",
    ...
    },
    {
        ...
        "title": "Read SREGym benchmark stage",
    ...
    },
    {
        ...
        "title": "Execute kubectl through SREGym kubectl MCP",
        "binding": "run_kubectl",
        "consequence": "DO",
        "route": "/kubectl/sse",
    ...
    },
    {
        ...
        "title": "Submit diagnosis through SREGym submit MCP",
        "binding": "submit_diagnosis",
        "consequence": "DO",
        "route": "/submit_mcp/sse",
        "tool_name": "submit",
    },
    {
        "iri": "urn:gymact:sregym:capability:submit_mitigation",
        "title": "Submit mitigation through SREGym submit MCP",
    ...
    },
    {
        ...
        "title": "Jaeger get_dependency_graph",
...
PROGRAM_STEP_ROWS = (
    (
        ...
        "urn:gymact:sregym:capability:submit_diagnosis",
        {
            ...
            "cause": "internalTrafficPolicy=Local plus pinned recommendation/frontend pods causes cross-node in-cluster requests to be dropped",
            "gdmcp_source": _INTERNAL_TRAFFIC,
        },
    ...
    (
        ...
        {
            "command": 'kubectl patch service recommendation -n {{namespace}} --type=merge -p \'{"spec":{"internalTrafficPolicy":"Cluster"}}\''
        },
    ...
    (
        ...
        "urn:gymact:sregym:capability:run_kubectl",
        {
            "command": 'kubectl patch deployment recommendation -n {{namespace}} --type=merge -p \'{"spec":{"template":{"spec":{"nodeSelector":null}}}}\''
        },
    ...
    (
        ...
        "urn:gymact:sregym:capability:run_kubectl",
        {
            "command": 'kubectl patch deployment frontend -n {{namespace}} --type=merge -p \'{"spec":{"template":{"spec":{"nodeSelector":null}}}}\''
        },
    ...
    (
        ...
        "urn:gymact:sregym:capability:run_kubectl",
        {
            "command": "kubectl rollout status deployment/recommendation -n {{namespace}} --timeout=180s"
        },
    ...
    (
        ...
        {
            "action": "restored internalTrafficPolicy=Cluster, removed both injected nodeSelectors, and waited for both deployments to roll out",
            "gdmcp_source": _INTERNAL_TRAFFIC,
        },
    ...
    (
        ...
        {
            "component": "frontend",
            "cause": "deployment frontend has dnsPolicy=None and an external 8.8.8.8 resolver, breaking cluster-internal DNS resolution",
            "gdmcp_source": _WRONG_DNS,
        },
        "submit the source-grounded diagnosis; no model inference",
        _WRONG_DNS,
    ),
    (
        ...
        "urn:gymact:sregym:capability:run_kubectl",
        {
            "command": 'kubectl patch deployment frontend -n {{namespace}} --type=json -p=\'[{"op":"remove","path":"/spec/template/spec/dnsPolicy"},{"op":"remove","path":"/spec/template/spec/dnsConfig"}]\''
        },
    ...
    (
        ...
        3,
        "urn:gymact:sregym:capability:run_kubectl",
        {"command": "kubectl rollout status deployment frontend -n {{namespace}} --timeout=120s"},
    ...
    (
        ...
        "urn:gymact:sregym:capability:submit_mitigation",
        {
            "action": "removed the injected dnsPolicy/dnsConfig override and waited for the frontend rollout",
            "gdmcp_source": _WRONG_DNS_INJECTOR,
        },
        "submit the deterministic mitigation evidence",
        _WRONG_DNS_INJECTOR,
    ),
