...
def construct_feedback_plan(subject: Subject, calibration: GainCalibration, drift: bool, regret: Fraction, policy: FeedbackPolicy) -> tuple[FeedbackPlan, FeedbackReceipt]:
