...
def admit_oracle_agreement(
    primary: Fraction, exhaustive: Fraction, witness: IndependentWitness
) -> OracleAgreement:
    ...
    if primary != witness.primal or primary != witness.dual:
        raise IndependentVerifierRefusal(
            "PRIMAL_DUAL_ORACLE_DIVERGENCE",
            f"primary={primary},primal={witness.primal},dual={witness.dual}",
        )
