    ...
    def tasks(self) -> tuple[OntologyTask, ...]:
        return tuple(
            OntologyTask(
                ...
                # The generic environment establishes declared subjects.  The
                # capability title is the bounded execution fact projected from
                # dcterms:title; no provider-specific mutation is performed.
