...
def qualify(
    *,
    ...
    current: dict[str, ProducerEpoch],
    ...
    standing = (
        ...
        if any(o in (Outcome.PENDING, Outcome.UNKNOWN) for o in outcomes)
        else "UNSUPPORTED"
        if outcomes and all(o is Outcome.UNSUPPORTED for o in outcomes)
        else "PARTIAL_ALIVE"
    )
