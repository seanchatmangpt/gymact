...
def dominates(a: ObjectiveVector, b: ObjectiveVector) -> bool:
    no_worse = a.information >= b.information and a.diversity >= b.diversity and a.cost <= b.cost and a.latency <= b.latency
    better = a.information > b.information or a.diversity > b.diversity or a.cost < b.cost or a.latency < b.latency
